...
public:
    ...
    */
	...
	// Creates a tree and basket actor using the tree factory
	/// \param treeNum represents which tree to add
	void CreateTreeActor(int treeNum);

	/// Is there a tree 1
	/// \returns Is there a tree 1
	bool IsTree1() { return mIsTree1; }

	/// Is there a tree 2
	/// \returns Is there a tree 2
	bool IsTree2() { return mIsTree2; }
...
private:
	...
	bool mIsTree1 = false; ///< Is there a tree 1
	bool mIsTree2 = false; ///< Is there a tree 2
};
