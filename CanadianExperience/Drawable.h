...
public:
	...
	/// Gets the drawable's actor
	/// \returns The actor that holds the drawable
    ...
    * \returns Iter object at position past the end */
	...
	/// Empty function for all but the tree, since the tree can only be harvested
	/// \param frame The frame that harvest was called on
	virtual void Harvest(int frame) {}

	/// Empty function for all but the basket, since only baskets can be emptied
