...
public:
    ...
    * \returns Pointer to animation channel */
	...
	/// Sets the actor to being a tree or not
	/// \param isTree if it is a tree or not
	void SetIsTree(bool isTree) { mIsTree = isTree; }

	/// Is the actor a tree
	/// \returns If it's a tree or not
	bool IsTree() { return mIsTree; }
